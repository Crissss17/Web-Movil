        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex flex-shrink-0 items-center">
              <h1 className="h-10 w-auto text-white text-5xl font-bold">WebQuest</h1>
            </div>
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                ...
                <Link to={"/MisServicios"} className="text-white hover:bg-[#95D5B2] hover:text-white rounded-md px-3 py-2 text-sm font-medium">Mis Cuestionarios</Link>
